...
class Button():
    ...
    def __init__(self, orig, text='Valider', text2='Passer'):
        # Texte
        font = pygame.font.SysFont('comicsans', 36)
        self.text = font.render(text, True, FOREGROUND)
        self.text2 = font.render(text2, True, FOREGROUND)
        self.alternative_text = False
        self.subtext = None
    ...
    def draw(self, screen):
        ...
        if self.subtext!=None:
            if self.alternative_text:
                screen.blit(self.text2, (self.bx0+10, self.by0+5))
            else:
            ...
            if self.alternative_text:
                screen.blit(self.text2, (self.bx0+10, self.by0+self.bh/2-self.text2.get_height()/2))
            else:
    ...
    def set_alternative(self, bool):
        self.alternative_text = bool
